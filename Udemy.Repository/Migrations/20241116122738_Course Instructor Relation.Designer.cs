...
namespace Udemy.Repository.Migrations
{
    ...
    [Migration("20241116122738_Course Instructor Relation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Udemy.Domain.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Udemy.Domain.Models.ChapterLecture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Udemy.Domain.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Udemy.Domain.Models.ChapterLecture", b =>
                {
                    b.HasOne("Udemy.Domain.Models.CourseChapter", "CourseChapter")
            ...
            modelBuilder.Entity("Udemy.Domain.Models.Course", b =>
                {
                    b.HasOne("Udemy.Domain.Models.CourseCategory", "Category")
                        .WithMany("courses")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Udemy.Domain.Models.ApplicationUser", "Instructor")
            ...
            modelBuilder.Entity("Udemy.Domain.Models.CourseChapter", b =>
                {
                    b.HasOne("Udemy.Domain.Models.Course", "Course")
            ...
            modelBuilder.Entity("Udemy.Domain.Models.CourseReview", b =>
                {
                    ...
                    b.HasOne("Udemy.Domain.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Udemy.Domain.Models.Payment", b =>
                {
                    b.HasOne("Udemy.Domain.Models.ApplicationUser", "Buyer")
                        .WithMany("Payments")
