        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviewPictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coureses_CourseCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseChapters_Coureses_Course_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseReviews_Coureses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Coureses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_Coureses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Coureses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastWatchedLectureId = table.Column<int>(type: "int", nullable: false),
                    CompletedPercentage = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student_Courses", x => new { x.UserId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_Student_Courses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChapterLectures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChapterLectures_CourseChapters_ChapterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChapterLectures_ChapterId",
                table: "ChapterLectures",
                column: "ChapterId");

            migrationBuilder.CreateIndex(
                name: "IX_Coureses_CategoryId",
                table: "Coureses",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseChapters_Course_id",
